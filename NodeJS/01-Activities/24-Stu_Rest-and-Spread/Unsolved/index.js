...
// TODO: What do you expect to be logged in the console? - all elements from 'songs'
...
const addition = (x, y, z) => {
  ...
  return array.reduce((a, b) => a + b, 0); // reduce array to 2 elements by adding first params
};
...
const additionSpread = (...array) => {
  return array.reduce((a, b) => a + b, 0); // callback function
};
